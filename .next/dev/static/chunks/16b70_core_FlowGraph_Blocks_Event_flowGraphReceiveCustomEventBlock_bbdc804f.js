...
"[project]/node_modules/@babylonjs/core/FlowGraph/Blocks/Event/flowGraphReceiveCustomEventBlock.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphCoordinator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@babylonjs/core/FlowGraph/flowGraphCoordinator.js [app-client] (ecmascript)");
;
;
;
;
class FlowGraphReceiveCustomEventBlock extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphEventBlock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphEventBlock"] {
    constructor(/**
    ...
    _preparePendingTasks(context) {
        ...
        if (observable && observable.hasObservers() && observable.observers.length > __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphCoordinator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphCoordinator"].MaxEventsPerType) {
            this._reportError(context, `FlowGraphReceiveCustomEventBlock: Too many observers for event ${this.config.eventId}. Max is ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphCoordinator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphCoordinator"].MaxEventsPerType}.`);
            return;
        }
    ...
    _cancelPendingTasks(context) {
        ...
        if (observable) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].Warn(`FlowGraphReceiveCustomEventBlock: Missing observable for event ${this.config.eventId}`);
        }
    }
...
//# sourceMappingURL=16b70_core_FlowGraph_Blocks_Event_flowGraphReceiveCustomEventBlock_bbdc804f.js.map