...
"[project]/node_modules/@babylonjs/core/FlowGraph/Blocks/Execution/ControlFlow/flowGraphWaitAllBlock.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class FlowGraphWaitAllBlock extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphExecutionBlockWithOutSignal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphExecutionBlockWithOutSignal"] {
    constructor(/**
     ...
     */ config){
        ...
        this.remainingInputs = this.registerDataOutput("remainingInputs", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphRichTypes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RichTypeFlowGraphInteger"], new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$CustomTypes$2f$flowGraphInteger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphInteger"](this.config.inputSignalCount || 0));
    ...
    _execute(context, callingSignal) {
        ...
        this.remainingInputs.setValue(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$CustomTypes$2f$flowGraphInteger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphInteger"](activationState.filter((v)=>!v).length), context);
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$typeStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RegisterClass"])("FlowGraphWaitAllBlock" /* FlowGraphBlockNames.WaitAll */ , FlowGraphWaitAllBlock); //# sourceMappingURL=flowGraphWaitAllBlock.js.map
}),
]);

//# sourceMappingURL=16b70_core_FlowGraph_Blocks_Execution_ControlFlow_flowGraphWaitAllBlock_5ecc1f2a.js.map