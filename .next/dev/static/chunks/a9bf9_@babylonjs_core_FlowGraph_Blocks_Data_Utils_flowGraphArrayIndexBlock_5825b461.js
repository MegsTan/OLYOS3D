...
"[project]/node_modules/@babylonjs/core/FlowGraph/Blocks/Data/Utils/flowGraphArrayIndexBlock.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class FlowGraphArrayIndexBlock extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphBlock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphBlock"] {
    /**
     ...
     */ constructor(config){
        super(config);
        this.config = config;
        this.array = this.registerDataInput("array", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphRichTypes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RichTypeAny"]);
        this.index = this.registerDataInput("index", __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$flowGraphRichTypes$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RichTypeAny"], new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$CustomTypes$2f$flowGraphInteger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FlowGraphInteger"](-1));
     ...
     */ _updateOutputs(context) {
        ...
        const index = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$FlowGraph$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNumericValue"])(this.index.getValue(context));
...
//# sourceMappingURL=a9bf9_%40babylonjs_core_FlowGraph_Blocks_Data_Utils_flowGraphArrayIndexBlock_5825b461.js.map