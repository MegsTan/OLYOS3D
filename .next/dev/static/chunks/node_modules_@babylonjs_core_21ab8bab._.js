...
"[project]/node_modules/@babylonjs/core/Misc/basisWorker.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function initializeWebWorker(worker, wasmBinary, moduleUrl) {
    return await new Promise((res, reject)=>{
        ...
        worker.postMessage({
            action: "init",
            url: moduleUrl ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].GetBabylonScriptURL(moduleUrl) : undefined,
            wasmBinary
        }, [
            wasmBinary
        ]);
...
"[project]/node_modules/@babylonjs/core/Misc/basis.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$basisWorker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@babylonjs/core/Misc/basisWorker.js [app-client] (ecmascript)");
;
;
;
;
...
const BasisToolsOptions = {
     ...
     */ JSModuleURL: `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"]._DefaultCdnUrl}/basisTranscoder/1/basis_transcoder.js`,
    /**
     * URL to use when loading the wasm module for the transcoder
     */ WasmModuleURL: `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"]._DefaultCdnUrl}/basisTranscoder/1/basis_transcoder.wasm`
};
    ...
    if (!WorkerPromise) {
        WorkerPromise = new Promise((res, reject)=>{
            if (LocalWorker) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].LoadFileAsync(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].GetBabylonScriptURL(BasisToolsOptions.WasmModuleURL))// eslint-disable-next-line github/no-then
                .then((wasmBinary)=>{
                    ...
                    const workerBlobUrl = URL.createObjectURL(new Blob([
                        `(${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$basisWorker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["workerFunction"]})()`
                    ], {
                        type: "application/javascript"
                    }));
                    LocalWorker = new Worker(workerBlobUrl);
                    // eslint-disable-next-line github/no-then
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$basisWorker$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeWebWorker"])(LocalWorker, wasmBinary, BasisToolsOptions.JSModuleURL).then(res, reject);
                })// eslint-disable-next-line github/no-then
                .catch(reject);
            }
        });
    ...
    for(let i = 0; i < transcodeResult.fileInfo.images.length; i++){
        ...
        if (transcodeResult.format === -1 || transcodeResult.format === BASIS_FORMATS.cTFRGB565) {
            ...
            if (engine._features.basisNeedsPOT && (Math.log2(rootImage.width) % 1 !== 0 || Math.log2(rootImage.height) % 1 !== 0)) {
                ...
                const source = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Textures$2f$internalTexture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InternalTexture"](engine, 2 /* InternalTextureSource.Temp */ );
                texture._invertVScale = texture.invertY;
                source.type = 10;
                source.format = 4;
            ...
            if (engine._features.basisNeedsPOT && (Math.log2(texture.width) % 1 !== 0 || Math.log2(texture.height) % 1 !== 0)) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].Warn("Loaded .basis texture width and height are not a power of two. Texture wrapping will be set to Texture.CLAMP_ADDRESSMODE as other modes are not supported with non power of two dimensions in webGL 1.");
                texture._cachedWrapU = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Textures$2f$texture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Texture"].CLAMP_ADDRESSMODE;
                texture._cachedWrapV = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Materials$2f$Textures$2f$texture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Texture"].CLAMP_ADDRESSMODE;
            }
        }
    }
};
...
"[project]/node_modules/@babylonjs/core/Materials/Textures/Loaders/basisTextureLoader.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$basis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@babylonjs/core/Misc/basis.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@babylonjs/core/Misc/tools.js [app-client] (ecmascript)");
;
;
class _BasisTextureLoader {
     ...
     */ loadCubeData(data, texture, createPolynomials, onLoad, onError) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$basis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TranscodeAsync"])(data, transcodeConfig)// eslint-disable-next-line github/no-then
        .then((result)=>{
            const hasMipmap = result.fileInfo.images[0].levels.length > 1 && texture.generateMipMaps;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$basis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadTextureFromTranscodeResult"])(texture, result);
        ...
        .catch((err)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].Warn(errorMessage);
            texture.isReady = true;
            if (onError) {
                onError(err);
            }
     ...
     */ loadData(data, texture, callback) {
        ...
        .catch((err)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].Warn("Failed to transcode Basis file, transcoding may not be supported on this device");
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babylonjs$2f$core$2f$Misc$2f$tools$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tools"].Warn(`Failed to transcode Basis file: ${err}`);
...
//# sourceMappingURL=node_modules_%40babylonjs_core_21ab8bab._.js.map