module.exports=[45865,19719,14242,36839,99715,42965,9549,33288,90064,86589,11474,36141,a=>{"use strict";var b=a.i(25562);a.i(4045);let c="pbrFragmentExtraDeclaration",d=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([],45865);let e="subSurfaceScatteringFunctions",f=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.s([],19719);let g="pbrHelperFunctions",h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[g]||(b.ShaderStore.IncludesShadersStoreWGSL[g]=h),a.s([],14242),a.i(2524);let i="pbrDirectLightingSetupFunctions",j=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[i]||(b.ShaderStore.IncludesShadersStoreWGSL[i]=j),a.s([],36839);let k="pbrDirectLightingFalloffFunctions",l=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;b.ShaderStore.IncludesShadersStoreWGSL[k]||(b.ShaderStore.IncludesShadersStoreWGSL[k]=l),a.s([],99715),a.i(80354);let m="pbrBlockReflectance0",n=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[m]||(b.ShaderStore.IncludesShadersStoreWGSL[m]=n),a.s([],42965);let o="pbrDirectLightingFunctions",p=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[o]||(b.ShaderStore.IncludesShadersStoreWGSL[o]=p),a.s([],9549);let q="pbrIBLFunctions",r=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[q]||(b.ShaderStore.IncludesShadersStoreWGSL[q]=r),a.s([],33288);let s="pbrBlockNormalGeometric",t=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[s]||(b.ShaderStore.IncludesShadersStoreWGSL[s]=t),a.s([],90064);let u="pbrBlockImageProcessing",v=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[u]||(b.ShaderStore.IncludesShadersStoreWGSL[u]=v),a.s([],86589);let w="pbrBlockPrePass",x=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[w]||(b.ShaderStore.IncludesShadersStoreWGSL[w]=x),a.s([],11474);let y="pbrDebug",z=`#if DEBUGMODE>0
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[y]||(b.ShaderStore.IncludesShadersStoreWGSL[y]=z),a.s([],36141)}];

//# sourceMappingURL=a9bf9_%40babylonjs_core_ShadersWGSL_ShadersInclude_pbrFragmentExtraDeclaration_4577d7f0.js.map