module.exports=[70259,29657,39820,50312,13424,81943,76729,60213,75420,12103,41052,a=>{"use strict";var b=a.i(25562);a.i(44561);let c="pbrFragmentExtraDeclaration",d=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],70259);let e="subSurfaceScatteringFunctions",f=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],29657);let g="pbrHelperFunctions",h=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.s([],39820),a.i(28439);let i="pbrDirectLightingSetupFunctions",j=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;b.ShaderStore.IncludesShadersStore[i]||(b.ShaderStore.IncludesShadersStore[i]=j),a.s([],50312);let k="pbrDirectLightingFalloffFunctions",l=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;b.ShaderStore.IncludesShadersStore[k]||(b.ShaderStore.IncludesShadersStore[k]=l),a.s([],13424);let m="pbrDirectLightingFunctions",n=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;b.ShaderStore.IncludesShadersStore[m]||(b.ShaderStore.IncludesShadersStore[m]=n),a.s([],81943);let o="pbrIBLFunctions",p=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;b.ShaderStore.IncludesShadersStore[o]||(b.ShaderStore.IncludesShadersStore[o]=p),a.s([],76729);let q="pbrBlockNormalGeometric",r=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;b.ShaderStore.IncludesShadersStore[q]||(b.ShaderStore.IncludesShadersStore[q]=r),a.s([],60213);let s="pbrBlockImageProcessing",t=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;b.ShaderStore.IncludesShadersStore[s]||(b.ShaderStore.IncludesShadersStore[s]=t),a.s([],75420);let u="pbrBlockPrePass",v=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[u]||(b.ShaderStore.IncludesShadersStore[u]=v),a.s([],12103);let w="pbrDebug",x=`#if DEBUGMODE>0
...
#endif
`;b.ShaderStore.IncludesShadersStore[w]||(b.ShaderStore.IncludesShadersStore[w]=x),a.s([],41052)}];

//# sourceMappingURL=a9bf9_%40babylonjs_core_Shaders_ShadersInclude_pbrFragmentExtraDeclaration_f7fa3a61.js.map