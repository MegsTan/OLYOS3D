module.exports=[32274,a=>{"use strict";var b=a.i(25562);let c="screenSpaceReflection2BlurPixelShader",d=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
`;b.ShaderStore.ShadersStore[c]||(b.ShaderStore.ShadersStore[c]=d),a.s(["screenSpaceReflection2BlurPixelShader",0,{name:c,shader:d}])}];
