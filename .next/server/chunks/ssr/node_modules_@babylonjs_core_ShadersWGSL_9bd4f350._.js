module.exports=[435,97011,a=>{"use strict";var b=a.i(25562);let c="clipPlaneFragmentDeclaration",d=`#ifdef CLIPPLANE
...
{discard;}
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.s([],97011)},92619,a=>{"use strict";var b=a.i(25562);let c="packingFunctions",d=`fn pack(depth: f32)->vec4f
{const bit_shift: vec4f= vec4f(255.0*255.0*255.0,255.0*255.0,255.0,1.0);const bit_mask: vec4f= vec4f(0.0,1.0/255.0,1.0/255.0,1.0/255.0);var res: vec4f=fract(depth*bit_shift);res-=res.xxyz*bit_mask;return res;}
fn unpack(color: vec4f)->f32
{const bit_shift: vec4f= vec4f(1.0/(255.0*255.0*255.0),1.0/(255.0*255.0),1.0/255.0,1.0);return dot(color,bit_shift);}`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},33842,a=>{"use strict";var b=a.i(25562);a.i(92619);let c="bayerDitherFunctions",d=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
varying zSM: f32;
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.i(435),a.i(97011);let g="shadowMapFragment",h=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[g]||(b.ShaderStore.IncludesShadersStoreWGSL[g]=h);let i="shadowMapPixelShader",j=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;b.ShaderStore.ShadersStoreWGSL[i]||(b.ShaderStore.ShadersStoreWGSL[i]=j),a.s(["shadowMapPixelShaderWGSL",0,{name:i,shader:j}],33842)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_ShadersWGSL_9bd4f350._.js.map