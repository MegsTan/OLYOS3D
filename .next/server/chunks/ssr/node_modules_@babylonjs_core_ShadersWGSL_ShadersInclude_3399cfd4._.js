module.exports=[30447,a=>{"use strict";var b=a.i(25562);let c="reflectionFunction",d=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},30981,a=>{"use strict";var b=a.i(25562);let c="lightUboDeclaration",d=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},2524,80354,a=>{"use strict";var b=a.i(25562);let c="ltcHelperFunctions",d=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([],2524);let e="clusteredLightingFunctions",f=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.s([],80354)},36816,a=>{"use strict";var b=a.i(25562);let c="shadowsFragmentFunctions",d=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
//# sourceMappingURL=node_modules_%40babylonjs_core_ShadersWGSL_ShadersInclude_3399cfd4._.js.map