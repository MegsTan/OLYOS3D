module.exports=[51308,a=>{"use strict";var b=a.i(25562);let c="pbrBRDFFunctions",d=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([],36983);let e="hdrFilteringFunctions",f=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.s([],27387)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_ShadersWGSL_ShadersInclude_9374e4ee._.js.map