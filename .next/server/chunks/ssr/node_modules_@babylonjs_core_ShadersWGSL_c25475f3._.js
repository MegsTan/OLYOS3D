...
#endif
#endif 
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},507,a=>{"use strict";var b=a.i(25562);let c="screenSpaceRayTrace",d=`fn distanceSquared(a: vec2f,b: vec2f)->f32 { 
var temp=a-b; 
...
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},93571,a=>{"use strict";var b=a.i(25562);a.i(63068),a.i(51308),a.i(507);let c="screenSpaceReflection2BlurCombinerPixelShader",d=`var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>; 
...
`;b.ShaderStore.ShadersStoreWGSL[c]||(b.ShaderStore.ShadersStoreWGSL[c]=d),a.s(["screenSpaceReflection2BlurCombinerPixelShaderWGSL",0,{name:c,shader:d}])}];
