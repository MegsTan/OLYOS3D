...
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},51308,a=>{"use strict";var b=a.i(25562);let c="pbrBRDFFunctions",d=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},4045,a=>{"use strict";var b=a.i(25562);let c="mainUVVaryingDeclaration",d=`#ifdef MAINUV{X}
...
#define WORLD_UBO
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.s([])},54147,a=>{"use strict";var b=a.i(25562);let c="harmonicsFunctions",d=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
}`;b.ShaderStore.ShadersStoreWGSL[g]||(b.ShaderStore.ShadersStoreWGSL[g]=h),a.s(["openpbrVertexShaderWGSL",0,{name:g,shader:h}],90324)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_ShadersWGSL_d80fd372._.js.map