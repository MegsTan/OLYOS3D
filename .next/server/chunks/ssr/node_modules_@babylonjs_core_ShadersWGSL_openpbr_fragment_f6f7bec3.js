module.exports=[63009,a=>{"use strict";var b=a.i(25562);a.i(15747),a.i(89762),a.i(57890),a.i(45865),a.i(30981),a.i(45386);let c="openpbrFragmentSamplersDeclaration",d=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d),a.i(96025),a.i(435),a.i(60815),a.i(42357),a.i(63068),a.i(19719),a.i(36983),a.i(14242),a.i(50492),a.i(36816),a.i(54147),a.i(36839),a.i(99715),a.i(51308),a.i(27387),a.i(9549),a.i(33288);let e="openpbrNormalMapFragmentMainFunctions",f=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f);let g="openpbrNormalMapFragmentFunctions",h=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[g]||(b.ShaderStore.IncludesShadersStoreWGSL[g]=h),a.i(30447);let i="openpbrDielectricReflectance",j=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;b.ShaderStore.IncludesShadersStoreWGSL[i]||(b.ShaderStore.IncludesShadersStoreWGSL[i]=j);let k="openpbrConductorReflectance",l=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;b.ShaderStore.IncludesShadersStoreWGSL[k]||(b.ShaderStore.IncludesShadersStoreWGSL[k]=l);let m="openpbrAmbientOcclusionFunctions",n=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;b.ShaderStore.IncludesShadersStoreWGSL[m]||(b.ShaderStore.IncludesShadersStoreWGSL[m]=n);let o="openpbrGeometryInfo",p=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;b.ShaderStore.IncludesShadersStoreWGSL[o]||(b.ShaderStore.IncludesShadersStoreWGSL[o]=p);let q="openpbrIblFunctions",r=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[q]||(b.ShaderStore.IncludesShadersStoreWGSL[q]=r),a.i(97011),a.i(90064);let s="openpbrNormalMapFragment",t=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[s]||(b.ShaderStore.IncludesShadersStoreWGSL[s]=t);let u="openpbrBlockNormalFinal",v=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[u]||(b.ShaderStore.IncludesShadersStoreWGSL[u]=v);let w="openpbrBaseLayerData",x=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[y]||(b.ShaderStore.IncludesShadersStoreWGSL[y]=z);let A="openpbrCoatLayerData",B=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[A]||(b.ShaderStore.IncludesShadersStoreWGSL[A]=B);let C="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[C]||(b.ShaderStore.IncludesShadersStoreWGSL[C]=D);let E="openpbrFuzzLayerData",F=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[E]||(b.ShaderStore.IncludesShadersStoreWGSL[E]=F);let G="openpbrAmbientOcclusionData",H=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[G]||(b.ShaderStore.IncludesShadersStoreWGSL[G]=H),a.i(70124);let I="openpbrBackgroundTransmission",J=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[I]||(b.ShaderStore.IncludesShadersStoreWGSL[I]=J);let K="openpbrEnvironmentLighting",L=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[K]||(b.ShaderStore.IncludesShadersStoreWGSL[K]=L);let M="openpbrDirectLightingInit",N=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[M]||(b.ShaderStore.IncludesShadersStoreWGSL[M]=N);let O="openpbrDirectLighting",P=`#ifdef LIGHT{X}
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[O]||(b.ShaderStore.IncludesShadersStoreWGSL[O]=P),a.i(10897),a.i(16972),a.i(86589),a.i(11474),a.i(52591),a.i(36141);let Q="openpbrPixelShader",R=`#define OPENPBR_FRAGMENT_SHADER
...
`;b.ShaderStore.ShadersStoreWGSL[Q]||(b.ShaderStore.ShadersStoreWGSL[Q]=R),a.s(["openpbrPixelShaderWGSL",0,{name:Q,shader:R}],63009)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_ShadersWGSL_openpbr_fragment_f6f7bec3.js.map