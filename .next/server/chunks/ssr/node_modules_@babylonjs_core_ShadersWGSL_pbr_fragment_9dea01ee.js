module.exports=[34585,a=>{"use strict";var b=a.i(25562);a.i(15747),a.i(89762),a.i(92330),a.i(45865),a.i(30981),a.i(45386);let c="samplerFragmentAlternateDeclaration",d=`#ifdef _DEFINENAME_
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[c]||(b.ShaderStore.IncludesShadersStoreWGSL[c]=d);let e="pbrFragmentSamplersDeclaration",f=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[e]||(b.ShaderStore.IncludesShadersStoreWGSL[e]=f),a.i(96025),a.i(435),a.i(60815),a.i(42357),a.i(63068),a.i(19719),a.i(36983),a.i(14242),a.i(50492),a.i(36816),a.i(54147),a.i(36839),a.i(99715),a.i(51308),a.i(27387),a.i(9549),a.i(33288),a.i(80887),a.i(82111),a.i(30447),a.i(23876);let g="pbrBlockAlbedoOpacity",h=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;b.ShaderStore.IncludesShadersStoreWGSL[g]||(b.ShaderStore.IncludesShadersStoreWGSL[g]=h);let i="pbrBlockReflectivity",j=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;b.ShaderStore.IncludesShadersStoreWGSL[i]||(b.ShaderStore.IncludesShadersStoreWGSL[i]=j);let k="pbrBlockAmbientOcclusion",l=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;b.ShaderStore.IncludesShadersStoreWGSL[k]||(b.ShaderStore.IncludesShadersStoreWGSL[k]=l);let m="pbrBlockAlphaFresnel",n=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[m]||(b.ShaderStore.IncludesShadersStoreWGSL[m]=n);let o="pbrBlockAnisotropic",p=`#ifdef ANISOTROPIC
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[o]||(b.ShaderStore.IncludesShadersStoreWGSL[o]=p);let q="pbrBlockReflection",r=`#ifdef REFLECTION
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[q]||(b.ShaderStore.IncludesShadersStoreWGSL[q]=r);let s="pbrBlockSheen",t=`#ifdef SHEEN
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[s]||(b.ShaderStore.IncludesShadersStoreWGSL[s]=t);let u="pbrBlockClearcoat",v=`struct clearcoatOutParams
...
return outParams;}
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[u]||(b.ShaderStore.IncludesShadersStoreWGSL[u]=v);let w="pbrBlockIridescence",x=`struct iridescenceOutParams
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[w]||(b.ShaderStore.IncludesShadersStoreWGSL[w]=x);let y="pbrBlockSubSurface",z=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[y]||(b.ShaderStore.IncludesShadersStoreWGSL[y]=z),a.i(97011),a.i(90064),a.i(89689);let A="pbrBlockNormalFinal",B=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[A]||(b.ShaderStore.IncludesShadersStoreWGSL[A]=B),a.i(70124);let C="pbrBlockLightmapInit",D=`#ifdef LIGHTMAP
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[C]||(b.ShaderStore.IncludesShadersStoreWGSL[C]=D);let E="pbrBlockGeometryInfo",F=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[E]||(b.ShaderStore.IncludesShadersStoreWGSL[E]=F),a.i(42965);let G="pbrBlockReflectance",H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[G]||(b.ShaderStore.IncludesShadersStoreWGSL[G]=H);let I="pbrBlockDirectLighting",J=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[I]||(b.ShaderStore.IncludesShadersStoreWGSL[I]=J),a.i(39654);let K="pbrBlockFinalLitComponents",L=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStoreWGSL[K]||(b.ShaderStore.IncludesShadersStoreWGSL[K]=L);let M="pbrBlockFinalUnlitComponents",N=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;b.ShaderStore.IncludesShadersStoreWGSL[M]||(b.ShaderStore.IncludesShadersStoreWGSL[M]=N);let O="pbrBlockFinalColorComposition",P=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;b.ShaderStore.IncludesShadersStoreWGSL[O]||(b.ShaderStore.IncludesShadersStoreWGSL[O]=P),a.i(10897),a.i(16972),a.i(86589),a.i(11474),a.i(52591),a.i(36141);let Q="pbrPixelShader",R=`#define PBR_FRAGMENT_SHADER
...
`;b.ShaderStore.ShadersStoreWGSL[Q]||(b.ShaderStore.ShadersStoreWGSL[Q]=R),a.s(["pbrPixelShaderWGSL",0,{name:Q,shader:R}],34585)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_ShadersWGSL_pbr_fragment_9dea01ee.js.map