...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],54999)},15598,a=>{"use strict";var b=a.i(25562);a.i(64653),a.i(73268),a.i(33676),a.i(54999);let c="hdrIrradianceFilteringPixelShader",d=`#include<helperFunctions>
...
,icdfTexture
#endif
);gl_FragColor=vec4(color*hdrScale,1.0);}`;b.ShaderStore.ShadersStore[c]||(b.ShaderStore.ShadersStore[c]=d),a.s(["hdrIrradianceFilteringPixelShader",0,{name:c,shader:d}])}];

//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_001661cf._.js.map