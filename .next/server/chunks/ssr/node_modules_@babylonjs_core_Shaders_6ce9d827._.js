module.exports=[99168,a=>{"use strict";var b=a.i(25562);a.i(58057);let c="backgroundUboDeclaration",d=`layout(std140,column_major) uniform;uniform Material
...
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},46877,a=>{"use strict";var b=a.i(25562);let c="backgroundFragmentDeclaration",d=`uniform vec4 vEyePosition;uniform vec4 vPrimaryColor;
...
uniform vec2 projectedGroundInfos;
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.i(99168),a.i(64653),a.i(20271),a.i(60721),a.i(10886),a.i(11866),a.i(20414),a.i(54186),a.i(45308),a.i(44248),a.i(81682),a.i(72930);let e="intersectionFunctions",f=`float diskIntersectWithBackFaceCulling(vec3 ro,vec3 rd,vec3 c,float r) {float d=rd.y;if(d>0.0) { return 1e6; }
...
h=sqrt(h);return vec2(-b+h,-b-h);}`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.i(74402),a.i(85716),a.i(30783),a.i(84701);let g="backgroundPixelShader",h=`#ifdef TEXTURELODSUPPORT
...
`;b.ShaderStore.ShadersStore[g]||(b.ShaderStore.ShadersStore[g]=h),a.s(["backgroundPixelShader",0,{name:g,shader:h}],46877)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_6ce9d827._.js.map