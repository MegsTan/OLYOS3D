...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],11866)},54186,a=>{"use strict";var b=a.i(25562);let c="shadowsFragmentFunctions",d=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},20271,a=>{"use strict";var b=a.i(25562);let c="reflectionFunction",d=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_ShadersInclude_01eceb98._.js.map