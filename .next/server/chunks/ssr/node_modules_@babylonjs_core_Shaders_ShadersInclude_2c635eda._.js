module.exports=[20632,85716,a=>{"use strict";var b=a.i(25562);let c="clusteredLightingFunctions",d=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],20632);let e="lightFragment",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],85716)},86919,a=>{"use strict";var b=a.i(25562);let c="meshUboDeclaration",d=`#ifdef WEBGL2
...
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},67289,a=>{"use strict";var b=a.i(25562);let c="decalFragmentDeclaration",d=`#ifdef DECAL
...
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],13365)},63649,53963,a=>{"use strict";var b=a.i(25562);let c="depthPrePass",d=`#ifdef DEPTHPREPASS
...
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],53963)},5489,a=>{"use strict";var b=a.i(25562);let c="decalFragment",d=`#ifdef DECAL
#ifdef GAMMADECAL
...
//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_ShadersInclude_2c635eda._.js.map