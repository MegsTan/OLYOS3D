module.exports=[20271,a=>{"use strict";var b=a.i(25562);let c="reflectionFunction",d=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},10886,11866,a=>{"use strict";var b=a.i(25562);let c="lightFragmentDeclaration",d=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],10886);let e="lightUboDeclaration",f=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},54186,a=>{"use strict";var b=a.i(25562);let c="shadowsFragmentFunctions",d=`#ifdef SHADOWS
...
//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_ShadersInclude_515ef62b._.js.map