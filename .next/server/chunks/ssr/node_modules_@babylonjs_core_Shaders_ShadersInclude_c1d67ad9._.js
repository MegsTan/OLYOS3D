...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],73268);let e="hdrFilteringFunctions",f=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],54999)},86919,a=>{"use strict";var b=a.i(25562);let c="meshUboDeclaration",d=`#ifdef WEBGL2
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},63491,13365,a=>{"use strict";var b=a.i(25562);let c="prePassDeclaration",d=`#ifdef PREPASS
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],63491);let e="oitDeclaration",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],13365)},67289,a=>{"use strict";var b=a.i(25562);let c="decalFragmentDeclaration",d=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},63649,53963,a=>{"use strict";var b=a.i(25562);let c="depthPrePass",d=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],63649);let e="oitFragment",f=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
