module.exports=[33676,a=>{"use strict";var b=a.i(25562);let c="pbrBRDFFunctions",d=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},86919,a=>{"use strict";var b=a.i(25562);let c="meshUboDeclaration",d=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},44561,a=>{"use strict";var b=a.i(25562);let c="mainUVVaryingDeclaration",d=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},70599,a=>{"use strict";var b=a.i(25562);let c="harmonicsFunctions",d=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},86302,a=>{"use strict";var b=a.i(25562);let c="vertexColorMixing",d=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([])},19684,93676,14719,a=>{"use strict";var b=a.i(25562);let c="lightVxFragmentDeclaration",d=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],19684);let e="lightVxUboDeclaration",f=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],93676);let g="shadowsVertex",h=`#ifdef SHADOWS
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.s([],14719)},56071,54689,69348,47025,24442,67217,99824,a=>{"use strict";var b=a.i(25562);let c="decalVertexDeclaration",d=`#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.s([],56071);let e="uvAttributeDeclaration",f=`#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],54689);let g="prePassVertexDeclaration",h=`#ifdef PREPASS
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.s([],69348);let i="samplerVertexDeclaration",j=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying vec2 v_VARYINGNAME_UV;
#endif
`;b.ShaderStore.IncludesShadersStore[i]||(b.ShaderStore.IncludesShadersStore[i]=j),a.s([],47025);let k="prePassVertex",l=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[k]||(b.ShaderStore.IncludesShadersStore[k]=l),a.s([],24442);let m="uvVariableDeclaration",n=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;b.ShaderStore.IncludesShadersStore[m]||(b.ShaderStore.IncludesShadersStore[m]=n),a.s([],67217);let o="samplerVertexImplementation",p=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.i(30162),a.i(54689),a.i(44561),a.i(64653),a.i(33676),a.i(99154),a.i(20125),a.i(6169),a.i(69348),a.i(47025),a.i(70599);let e="openpbrNormalMapVertexDeclaration",f=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.i(96790),a.i(6404),a.i(19684),a.i(93676),a.i(37034),a.i(43926),a.i(44248),a.i(54265),a.i(31041),a.i(37668),a.i(52115),a.i(75163),a.i(24442),a.i(67217),a.i(99824);let g="openpbrNormalMapVertex",h=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.i(3470),a.i(64403),a.i(14719),a.i(86302),a.i(5551);let i="openpbrVertexShader",j=`#define OPENPBR_VERTEX_SHADER
...
//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_a2a976c4._.js.map