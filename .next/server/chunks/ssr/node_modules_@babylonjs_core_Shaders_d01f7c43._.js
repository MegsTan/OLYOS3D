...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.s([],54999)},91155,a=>{"use strict";var b=a.i(25562);a.i(64653),a.i(73268),a.i(33676),a.i(54999);let c="hdrFilteringPixelShader",d=`#include<helperFunctions>
#include<importanceSampling>
#include<pbrBRDFFunctions>
#include<hdrFilteringFunctions>
uniform float alphaG;uniform samplerCube inputTexture;uniform vec2 vFilteringInfo;uniform float hdrScale;varying vec3 direction;void main() {vec3 color=radiance(alphaG,inputTexture,direction,vFilteringInfo);gl_FragColor=vec4(color*hdrScale,1.0);}`;b.ShaderStore.ShadersStore[c]||(b.ShaderStore.ShadersStore[c]=d),a.s(["hdrFilteringPixelShader",0,{name:c,shader:d}])}];

//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_d01f7c43._.js.map