module.exports=[30144,a=>{"use strict";var b=a.i(25562);let c="fxaaPixelShader",d=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=TEXTUREFUNC(textureSampler,posM,0.0);
#endif
}`;b.ShaderStore.ShadersStore[c]||(b.ShaderStore.ShadersStore[c]=d),a.s(["fxaaPixelShader",0,{name:c,shader:d}])}];

//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_fxaa_fragment_a0f58820.js.map