...
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f),a.i(30162),a.i(70259),a.i(10886),a.i(11866),a.i(64780);let g="openpbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.i(60721),a.i(81682),a.i(44248),a.i(72930),a.i(64653),a.i(29657),a.i(73268),a.i(39820),a.i(45308),a.i(54186),a.i(70599),a.i(50312),a.i(13424),a.i(33676),a.i(54999),a.i(81943),a.i(76729);let i="openpbrNormalMapFragmentMainFunctions",j=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;b.ShaderStore.IncludesShadersStore[i]||(b.ShaderStore.IncludesShadersStore[i]=j);let k="openpbrNormalMapFragmentFunctions",l=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;b.ShaderStore.IncludesShadersStore[k]||(b.ShaderStore.IncludesShadersStore[k]=l),a.i(20271);let m="openpbrDielectricReflectance",n=`struct ReflectanceParams
...
`;b.ShaderStore.IncludesShadersStore[m]||(b.ShaderStore.IncludesShadersStore[m]=n);let o="openpbrConductorReflectance",p=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;b.ShaderStore.IncludesShadersStore[o]||(b.ShaderStore.IncludesShadersStore[o]=p);let q="openpbrAmbientOcclusionFunctions",r=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;b.ShaderStore.IncludesShadersStore[q]||(b.ShaderStore.IncludesShadersStore[q]=r);let s="openpbrGeometryInfo",t=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;b.ShaderStore.IncludesShadersStore[s]||(b.ShaderStore.IncludesShadersStore[s]=t);let u="openpbrIblFunctions",v=`#ifdef REFLECTION
...
#endif
`;b.ShaderStore.IncludesShadersStore[u]||(b.ShaderStore.IncludesShadersStore[u]=v),a.i(74402),a.i(60213);let w="openpbrNormalMapFragment",x=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;b.ShaderStore.IncludesShadersStore[w]||(b.ShaderStore.IncludesShadersStore[w]=x);let y="openpbrBlockNormalFinal",z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[y]||(b.ShaderStore.IncludesShadersStore[y]=z);let A="openpbrBaseLayerData",B=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStore[C]||(b.ShaderStore.IncludesShadersStore[C]=D);let E="openpbrCoatLayerData",F=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;b.ShaderStore.IncludesShadersStore[E]||(b.ShaderStore.IncludesShadersStore[E]=F);let G="openpbrThinFilmLayerData",H=`#ifdef THIN_FILM
...
#endif
`;b.ShaderStore.IncludesShadersStore[G]||(b.ShaderStore.IncludesShadersStore[G]=H);let I="openpbrFuzzLayerData",J=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[I]||(b.ShaderStore.IncludesShadersStore[I]=J);let K="openpbrAmbientOcclusionData",L=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;b.ShaderStore.IncludesShadersStore[K]||(b.ShaderStore.IncludesShadersStore[K]=L),a.i(63649);let M="openpbrBackgroundTransmission",N=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;b.ShaderStore.IncludesShadersStore[M]||(b.ShaderStore.IncludesShadersStore[M]=N);let O="openpbrEnvironmentLighting",P=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[O]||(b.ShaderStore.IncludesShadersStore[O]=P);let Q="openpbrDirectLightingInit",R=`#ifdef LIGHT{X}
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[Q]||(b.ShaderStore.IncludesShadersStore[Q]=R);let S="openpbrDirectLighting",T=`#ifdef LIGHT{X}
...
#endif
`;b.ShaderStore.IncludesShadersStore[S]||(b.ShaderStore.IncludesShadersStore[S]=T),a.i(30783),a.i(84701),a.i(75420),a.i(12103),a.i(53963),a.i(41052);let U="openpbrPixelShader",V=`#define OPENPBR_FRAGMENT_SHADER
...
`;b.ShaderStore.ShadersStore[U]||(b.ShaderStore.ShadersStore[U]=V),a.s(["openpbrPixelShader",0,{name:U,shader:V}],29375)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_openpbr_fragment_fbb03817.js.map