...
`;b.ShaderStore.IncludesShadersStore[c]||(b.ShaderStore.IncludesShadersStore[c]=d),a.i(24915),a.i(70259),a.i(10886),a.i(11866),a.i(64780);let e="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[e]||(b.ShaderStore.IncludesShadersStore[e]=f);let g="pbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;b.ShaderStore.IncludesShadersStore[g]||(b.ShaderStore.IncludesShadersStore[g]=h),a.i(60721),a.i(81682),a.i(44248),a.i(72930),a.i(64653),a.i(29657),a.i(73268),a.i(39820),a.i(45308),a.i(54186),a.i(70599),a.i(50312),a.i(13424),a.i(33676),a.i(54999),a.i(81943),a.i(76729),a.i(96370),a.i(25022),a.i(20271),a.i(5489);let i="pbrBlockAlbedoOpacity",j=`struct albedoOpacityOutParams
...
`;b.ShaderStore.IncludesShadersStore[i]||(b.ShaderStore.IncludesShadersStore[i]=j);let k="pbrBlockReflectivity",l=`struct reflectivityOutParams
...
`;b.ShaderStore.IncludesShadersStore[k]||(b.ShaderStore.IncludesShadersStore[k]=l);let m="pbrBlockAmbientOcclusion",n=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;b.ShaderStore.IncludesShadersStore[m]||(b.ShaderStore.IncludesShadersStore[m]=n);let o="pbrBlockAlphaFresnel",p=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[o]||(b.ShaderStore.IncludesShadersStore[o]=p);let q="pbrBlockAnisotropic",r=`#ifdef ANISOTROPIC
...
#endif
`;b.ShaderStore.IncludesShadersStore[q]||(b.ShaderStore.IncludesShadersStore[q]=r);let s="pbrBlockReflection",t=`#ifdef REFLECTION
...
#endif
`;b.ShaderStore.IncludesShadersStore[s]||(b.ShaderStore.IncludesShadersStore[s]=t);let u="pbrBlockSheen",v=`#ifdef SHEEN
...
#endif
`;b.ShaderStore.IncludesShadersStore[u]||(b.ShaderStore.IncludesShadersStore[u]=v);let w="pbrBlockClearcoat",x=`struct clearcoatOutParams
...
return outParams;}
#endif
`;b.ShaderStore.IncludesShadersStore[w]||(b.ShaderStore.IncludesShadersStore[w]=x);let y="pbrBlockIridescence",z=`struct iridescenceOutParams
...
#endif
`;b.ShaderStore.IncludesShadersStore[y]||(b.ShaderStore.IncludesShadersStore[y]=z);let A="pbrBlockSubSurface",B=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;b.ShaderStore.IncludesShadersStore[A]||(b.ShaderStore.IncludesShadersStore[A]=B),a.i(20632);let C="pbrBlockReflectance0",D=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;b.ShaderStore.IncludesShadersStore[C]||(b.ShaderStore.IncludesShadersStore[C]=D);let E="pbrClusteredLightingFunctions",F=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;b.ShaderStore.IncludesShadersStore[E]||(b.ShaderStore.IncludesShadersStore[E]=F),a.i(74402),a.i(60213),a.i(46705);let G="pbrBlockNormalFinal",H=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[G]||(b.ShaderStore.IncludesShadersStore[G]=H),a.i(63649);let I="pbrBlockLightmapInit",J=`#ifdef LIGHTMAP
...
#endif
`;b.ShaderStore.IncludesShadersStore[I]||(b.ShaderStore.IncludesShadersStore[I]=J);let K="pbrBlockGeometryInfo",L=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[K]||(b.ShaderStore.IncludesShadersStore[K]=L);let M="pbrBlockReflectance",N=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[M]||(b.ShaderStore.IncludesShadersStore[M]=N);let O="pbrBlockDirectLighting",P=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;b.ShaderStore.IncludesShadersStore[O]||(b.ShaderStore.IncludesShadersStore[O]=P),a.i(85716);let Q="pbrBlockFinalLitComponents",R=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;b.ShaderStore.IncludesShadersStore[Q]||(b.ShaderStore.IncludesShadersStore[Q]=R);let S="pbrBlockFinalUnlitComponents",T=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;b.ShaderStore.IncludesShadersStore[S]||(b.ShaderStore.IncludesShadersStore[S]=T);let U="pbrBlockFinalColorComposition",V=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;b.ShaderStore.IncludesShadersStore[U]||(b.ShaderStore.IncludesShadersStore[U]=V),a.i(30783),a.i(84701),a.i(75420),a.i(12103),a.i(53963),a.i(41052);let W="pbrPixelShader",X=`#define PBR_FRAGMENT_SHADER
...
`;b.ShaderStore.ShadersStore[W]||(b.ShaderStore.ShadersStore[W]=X),a.s(["pbrPixelShader",0,{name:W,shader:X}],67306)}];

//# sourceMappingURL=node_modules_%40babylonjs_core_Shaders_pbr_fragment_acd36d87.js.map