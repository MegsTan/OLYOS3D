...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=t),e.s([],60334);let f="clipPlaneFragment",i=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[f]||(a.ShaderStore.IncludesShadersStoreWGSL[f]=i),e.s([],83784)},20928,e=>{"use strict";var a=e.i(47662);let r="samplerFragmentDeclaration",t=`#ifdef _DEFINENAME_
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=t),e.s([])},58420,51357,76632,e=>{"use strict";var a=e.i(47662);let r="bumpFragmentMainFunctions",t=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[r]||(a.ShaderStore.IncludesShadersStoreWGSL[r]=t),e.s([],58420),e.i(20928);let f="bumpFragmentFunctions",i=`#if defined(BUMP)
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[f]||(a.ShaderStore.IncludesShadersStoreWGSL[f]=i),e.s([],51357);let n="bumpFragment",l=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;a.ShaderStore.IncludesShadersStoreWGSL[n]||(a.ShaderStore.IncludesShadersStoreWGSL[n]=l),e.s([],76632)},87268,e=>{"use strict";var a=e.i(47662);e.i(60334),e.i(58420),e.i(51357),e.i(64500),e.i(83784),e.i(76632);let r="geometryPixelShader",t=`#ifdef BUMP
