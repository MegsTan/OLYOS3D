...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=n),e.s([])},60896,e=>{"use strict";var r=e.i(47662);let t="sceneUboDeclaration",n=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[d]||(r.ShaderStore.IncludesShadersStoreWGSL[d]=s),e.s([],47232)},48066,e=>{"use strict";var r=e.i(47662);e.i(97603),e.i(70456),e.i(77676),e.i(33883),e.i(64500),e.i(60896),e.i(80239);let t="shadowMapVertexExtraDeclaration",n=`#if SM_NORMALBIAS==1
