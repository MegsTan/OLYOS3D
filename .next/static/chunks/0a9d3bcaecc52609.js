(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,82656,31116,e=>{"use strict";var o=e.i(47662);let t="lightFragmentDeclaration",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([],82656);let r="lightUboDeclaration",a=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[r]||(o.ShaderStore.IncludesShadersStore[r]=a),e.s([],31116)},67654,e=>{"use strict";var o=e.i(47662);let t="shadowsFragmentFunctions",i=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([])},35716,e=>{"use strict";var o=e.i(47662);let t="reflectionFunction",i=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([])},78144,45107,e=>{"use strict";var o=e.i(47662);let t="prePassDeclaration",i=`#ifdef PREPASS
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([],78144);let r="oitDeclaration",a=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;o.ShaderStore.IncludesShadersStore[r]||(o.ShaderStore.IncludesShadersStore[r]=a),e.s([],45107)},58492,e=>{"use strict";var o=e.i(47662);let t="decalFragmentDeclaration",i=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([])},79795,56015,e=>{"use strict";var o=e.i(47662);let t="depthPrePass",i=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([],79795);let r="oitFragment",a=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;o.ShaderStore.IncludesShadersStore[r]||(o.ShaderStore.IncludesShadersStore[r]=a),e.s([],56015)},70562,27068,1010,49579,95368,78167,99434,25472,86272,28767,60382,e=>{"use strict";var o=e.i(47662);e.i(66058);let t="pbrFragmentExtraDeclaration",i=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;o.ShaderStore.IncludesShadersStore[t]||(o.ShaderStore.IncludesShadersStore[t]=i),e.s([],70562);let r="subSurfaceScatteringFunctions",a=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;o.ShaderStore.IncludesShadersStore[r]||(o.ShaderStore.IncludesShadersStore[r]=a),e.s([],27068);let l="pbrHelperFunctions",n=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;o.ShaderStore.IncludesShadersStore[l]||(o.ShaderStore.IncludesShadersStore[l]=n),e.s([],1010),e.i(78153);let s="pbrDirectLightingSetupFunctions",c=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;o.ShaderStore.IncludesShadersStore[s]||(o.ShaderStore.IncludesShadersStore[s]=c),e.s([],49579);let f="pbrDirectLightingFalloffFunctions",d=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;o.ShaderStore.IncludesShadersStore[f]||(o.ShaderStore.IncludesShadersStore[f]=d),e.s([],95368);let v="pbrDirectLightingFunctions",h=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;o.ShaderStore.IncludesShadersStore[v]||(o.ShaderStore.IncludesShadersStore[v]=h),e.s([],78167);let u="pbrIBLFunctions",p=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;o.ShaderStore.IncludesShadersStore[u]||(o.ShaderStore.IncludesShadersStore[u]=p),e.s([],99434);let g="pbrBlockNormalGeometric",S=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;o.ShaderStore.IncludesShadersStore[g]||(o.ShaderStore.IncludesShadersStore[g]=S),e.s([],25472);let m="pbrBlockImageProcessing",E=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;o.ShaderStore.IncludesShadersStore[m]||(o.ShaderStore.IncludesShadersStore[m]=E),e.s([],86272);let D="pbrBlockPrePass",C=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;o.ShaderStore.IncludesShadersStore[D]||(o.ShaderStore.IncludesShadersStore[D]=C),e.s([],28767);let L="pbrDebug",A=`#if DEBUGMODE>0
...
#endif
`;o.ShaderStore.IncludesShadersStore[L]||(o.ShaderStore.IncludesShadersStore[L]=A),e.s([],60382)}]);