(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,51894,13871,16507,70177,e=>{"use strict";var r=e.i(47662);let t="prePassDeclaration",o=`#ifdef PREPASS
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],51894);let a="oitDeclaration",i=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],13871);let f="depthPrePass",n=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[f]||(r.ShaderStore.IncludesShadersStoreWGSL[f]=n),e.s([],16507);let s="oitFragment",c=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[s]||(r.ShaderStore.IncludesShadersStoreWGSL[s]=c),e.s([],70177)},20928,e=>{"use strict";var r=e.i(47662);let t="samplerFragmentDeclaration",o=`#ifdef _DEFINENAME_
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},4560,27662,e=>{"use strict";var r=e.i(47662);let t="imageProcessingDeclaration",o=`#ifdef EXPOSURE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],4560);let a="imageProcessingFunctions",i=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],27662)},82742,e=>{"use strict";var r=e.i(47662);let t="logDepthFragment",o=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},60334,83784,e=>{"use strict";var r=e.i(47662);let t="clipPlaneFragmentDeclaration",o=`#ifdef CLIPPLANE
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],60334);let a="clipPlaneFragment",i=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],83784)},53270,75587,e=>{"use strict";var r=e.i(47662);let t="fogFragmentDeclaration",o=`#ifdef FOG
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],53270);let a="fogFragment",i=`#ifdef FOG
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],75587)},70619,e=>{"use strict";var r=e.i(47662);let t="lightUboDeclaration",o=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},70070,e=>{"use strict";var r=e.i(47662);let t="shadowsFragmentFunctions",o=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},97412,98135,e=>{"use strict";var r=e.i(47662);let t="ltcHelperFunctions",o=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],97412);let a="clusteredLightingFunctions",i=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],98135)},79799,e=>{"use strict";var r=e.i(47662);let t="reflectionFunction",o=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([])},33781,90617,11623,21743,26857,66364,40951,48424,72596,88558,86826,91032,e=>{"use strict";var r=e.i(47662);e.i(72033);let t="pbrFragmentExtraDeclaration",o=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=o),e.s([],33781);let a="subSurfaceScatteringFunctions",i=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=i),e.s([],90617);let f="pbrHelperFunctions",n=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[f]||(r.ShaderStore.IncludesShadersStoreWGSL[f]=n),e.s([],11623),e.i(97412);let s="pbrDirectLightingSetupFunctions",c=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[s]||(r.ShaderStore.IncludesShadersStoreWGSL[s]=c),e.s([],21743);let l="pbrDirectLightingFalloffFunctions",d=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;r.ShaderStore.IncludesShadersStoreWGSL[l]||(r.ShaderStore.IncludesShadersStoreWGSL[l]=d),e.s([],26857),e.i(98135);let v="pbrBlockReflectance0",u=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[v]||(r.ShaderStore.IncludesShadersStoreWGSL[v]=u),e.s([],66364);let p="pbrDirectLightingFunctions",h=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[p]||(r.ShaderStore.IncludesShadersStoreWGSL[p]=h),e.s([],40951);let m="pbrIBLFunctions",S=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[m]||(r.ShaderStore.IncludesShadersStoreWGSL[m]=S),e.s([],48424);let g="pbrBlockNormalGeometric",E=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[g]||(r.ShaderStore.IncludesShadersStoreWGSL[g]=E),e.s([],72596);let L="pbrBlockImageProcessing",D=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[L]||(r.ShaderStore.IncludesShadersStoreWGSL[L]=D),e.s([],88558);let C="pbrBlockPrePass",x=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[C]||(r.ShaderStore.IncludesShadersStoreWGSL[C]=x),e.s([],86826);let T="pbrDebug",A=`#if DEBUGMODE>0
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[T]||(r.ShaderStore.IncludesShadersStoreWGSL[T]=A),e.s([],91032)}]);