(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,5285,e=>{"use strict";var r=e.i(47662);e.i(51894),e.i(13871),e.i(65167),e.i(33781),e.i(70619),e.i(20928);let a="samplerFragmentAlternateDeclaration",i=`#ifdef _DEFINENAME_
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[n]||(r.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.i(4560),e.i(60334),e.i(47193),e.i(53270),e.i(64500),e.i(90617),e.i(2241),e.i(11623),e.i(27662),e.i(70070),e.i(85633),e.i(21743),e.i(26857),e.i(45595),e.i(36730),e.i(40951),e.i(48424),e.i(58420),e.i(51357),e.i(79799),e.i(49637);let o="pbrBlockAlbedoOpacity",t=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
return outParams;}
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[T]||(r.ShaderStore.IncludesShadersStoreWGSL[T]=L),e.i(83784),e.i(72596),e.i(76632);let _="pbrBlockNormalFinal",M=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[_]||(r.ShaderStore.IncludesShadersStoreWGSL[_]=M),e.i(16507);let F="pbrBlockLightmapInit",h=`#ifdef LIGHTMAP
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[D]||(r.ShaderStore.IncludesShadersStoreWGSL[D]=g),e.i(66364);let P="pbrBlockReflectance",U=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[b]||(r.ShaderStore.IncludesShadersStoreWGSL[b]=y),e.i(20385);let B="pbrBlockFinalLitComponents",G=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;r.ShaderStore.IncludesShadersStoreWGSL[H]||(r.ShaderStore.IncludesShadersStoreWGSL[H]=W),e.i(82742),e.i(75587),e.i(88558),e.i(86826),e.i(70177),e.i(91032);let Y="pbrPixelShader",k=`#define PBR_FRAGMENT_SHADER
...
`;r.ShaderStore.ShadersStoreWGSL[Y]||(r.ShaderStore.ShadersStoreWGSL[Y]=k),e.s(["pbrPixelShaderWGSL",0,{name:Y,shader:k}],5285)}]);