...
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=t),e.i(77098),e.i(70562),e.i(82656),e.i(31116),e.i(30550);let a="openpbrFragmentSamplersDeclaration",s=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;i.ShaderStore.IncludesShadersStore[a]||(i.ShaderStore.IncludesShadersStore[a]=s),e.i(57325),e.i(81239),e.i(45224),e.i(71154),e.i(87714),e.i(27068),e.i(28993),e.i(1010),e.i(77772),e.i(67654),e.i(30514),e.i(49579),e.i(95368),e.i(7199),e.i(33879),e.i(78167),e.i(99434);let f="openpbrNormalMapFragmentMainFunctions",l=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;i.ShaderStore.IncludesShadersStore[f]||(i.ShaderStore.IncludesShadersStore[f]=l);let c="openpbrNormalMapFragmentFunctions",d=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=d),e.i(35716);let _="openpbrDielectricReflectance",m=`struct ReflectanceParams
...
`;i.ShaderStore.IncludesShadersStore[_]||(i.ShaderStore.IncludesShadersStore[_]=m);let u="openpbrConductorReflectance",g=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;i.ShaderStore.IncludesShadersStore[u]||(i.ShaderStore.IncludesShadersStore[u]=g);let p="openpbrAmbientOcclusionFunctions",I=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;i.ShaderStore.IncludesShadersStore[p]||(i.ShaderStore.IncludesShadersStore[p]=I);let E="openpbrGeometryInfo",v=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;i.ShaderStore.IncludesShadersStore[E]||(i.ShaderStore.IncludesShadersStore[E]=v);let R="openpbrIblFunctions",S=`#ifdef REFLECTION
...
#endif
`;i.ShaderStore.IncludesShadersStore[R]||(i.ShaderStore.IncludesShadersStore[R]=S),e.i(79939),e.i(25472);let h="openpbrNormalMapFragment",N=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;i.ShaderStore.IncludesShadersStore[h]||(i.ShaderStore.IncludesShadersStore[h]=N);let T="openpbrBlockNormalFinal",A=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[T]||(i.ShaderStore.IncludesShadersStore[T]=A);let F="openpbrBaseLayerData",L=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;i.ShaderStore.IncludesShadersStore[b]||(i.ShaderStore.IncludesShadersStore[b]=O);let C="openpbrCoatLayerData",D=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;i.ShaderStore.IncludesShadersStore[C]||(i.ShaderStore.IncludesShadersStore[C]=D);let M="openpbrThinFilmLayerData",G=`#ifdef THIN_FILM
...
#endif
`;i.ShaderStore.IncludesShadersStore[M]||(i.ShaderStore.IncludesShadersStore[M]=G);let P="openpbrFuzzLayerData",x=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[P]||(i.ShaderStore.IncludesShadersStore[P]=x);let z="openpbrAmbientOcclusionData",y=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;i.ShaderStore.IncludesShadersStore[z]||(i.ShaderStore.IncludesShadersStore[z]=y),e.i(79795);let U="openpbrBackgroundTransmission",W=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;i.ShaderStore.IncludesShadersStore[U]||(i.ShaderStore.IncludesShadersStore[U]=W);let X="openpbrEnvironmentLighting",B=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[X]||(i.ShaderStore.IncludesShadersStore[X]=B);let H="openpbrDirectLightingInit",V=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[H]||(i.ShaderStore.IncludesShadersStore[H]=V);let w="openpbrDirectLighting",k=`#ifdef LIGHT{X}
...
#endif
`;i.ShaderStore.IncludesShadersStore[w]||(i.ShaderStore.IncludesShadersStore[w]=k),e.i(49426),e.i(72079),e.i(86272),e.i(28767),e.i(56015),e.i(60382);let Y="openpbrPixelShader",Z=`#define OPENPBR_FRAGMENT_SHADER
...
`;i.ShaderStore.ShadersStore[Y]||(i.ShaderStore.ShadersStore[Y]=Z),e.s(["openpbrPixelShader",0,{name:Y,shader:Z}],40333)}]);