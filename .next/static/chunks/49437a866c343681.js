...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=f),e.s([],7503)},72033,e=>{"use strict";var t=e.i(47662);let r="mainUVVaryingDeclaration",i=`#ifdef MAINUV{X}
...
#define WORLD_UBO
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},53707,88877,97280,66078,36226,32576,e=>{"use strict";var t=e.i(47662);let r="uvAttributeDeclaration",i=`#ifdef UV{X}
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[a]||(t.ShaderStore.IncludesShadersStoreWGSL[a]=o),e.s([],97280);let d="prePassVertex",s=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[d]||(t.ShaderStore.IncludesShadersStoreWGSL[d]=s),e.s([],66078);let u="uvVariableDeclaration",c=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[u]||(t.ShaderStore.IncludesShadersStoreWGSL[u]=c),e.s([],36226);let l="samplerVertexImplementation",v=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[l]||(t.ShaderStore.IncludesShadersStoreWGSL[l]=v),e.s([],32576)},5214,e=>{"use strict";var t=e.i(47662);let r="bumpVertexDeclaration",i=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=i),e.s([])},87873,e=>{"use strict";var t=e.i(47662);e.i(6504),e.i(53707),e.i(64500),e.i(97603),e.i(70456),e.i(33077),e.i(88877),e.i(72033),e.i(97280),e.i(5214),e.i(22352),e.i(62549);let r="lightVxFragmentDeclaration",i=`#ifdef LIGHT{X}
