(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,7199,e=>{"use strict";var i=e.i(47662);let o="pbrBRDFFunctions",t=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
#endif
#endif 
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},59791,e=>{"use strict";var i=e.i(47662);let o="meshUboDeclaration",t=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},66058,e=>{"use strict";var i=e.i(47662);let o="mainUVVaryingDeclaration",t=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},30514,e=>{"use strict";var i=e.i(47662);let o="harmonicsFunctions",t=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},77414,e=>{"use strict";var i=e.i(47662);let o="vertexColorMixing",t=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([])},24232,29344,41179,e=>{"use strict";var i=e.i(47662);let o="lightVxFragmentDeclaration",t=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([],24232);let n="lightVxUboDeclaration",a=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.s([],29344);let r="shadowsVertex",s=`#ifdef SHADOWS
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=s),e.s([],41179)},80801,26477,3590,39199,45898,84894,63990,e=>{"use strict";var i=e.i(47662);let o="decalVertexDeclaration",t=`#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.s([],80801);let n="uvAttributeDeclaration",a=`#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.s([],26477);let r="prePassVertexDeclaration",s=`#ifdef PREPASS
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=s),e.s([],3590);let f="samplerVertexDeclaration",l=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying vec2 v_VARYINGNAME_UV;
#endif
`;i.ShaderStore.IncludesShadersStore[f]||(i.ShaderStore.IncludesShadersStore[f]=l),e.s([],39199);let c="prePassVertex",d=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=d),e.s([],45898);let E="uvVariableDeclaration",_=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;i.ShaderStore.IncludesShadersStore[E]||(i.ShaderStore.IncludesShadersStore[E]=_),e.s([],84894);let N="samplerVertexImplementation",m=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.i(77098),e.i(26477),e.i(66058),e.i(87714),e.i(7199),e.i(68489),e.i(58483),e.i(8559),e.i(3590),e.i(39199),e.i(30514);let n="openpbrNormalMapVertexDeclaration",a=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.i(59092),e.i(91999),e.i(24232),e.i(29344),e.i(52690),e.i(10370),e.i(45224),e.i(88335),e.i(16389),e.i(32817),e.i(59862),e.i(2947),e.i(45898),e.i(84894),e.i(63990);let r="openpbrNormalMapVertex",s=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=s),e.i(34760),e.i(3011),e.i(41179),e.i(77414),e.i(41746);let f="openpbrVertexShader",l=`#define OPENPBR_VERTEX_SHADER
...
`;i.ShaderStore.ShadersStore[f]||(i.ShaderStore.ShadersStore[f]=l),e.s(["openpbrVertexShader",0,{name:f,shader:l}],63580)}]);