(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,47193,e=>{"use strict";var t=e.i(47662);let r="logDepthDeclaration",o=`#ifdef LOGARITHMICDEPTH
uniform logarithmicDepthConstant: f32;varying vFragmentDepth: f32;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},60896,e=>{"use strict";var t=e.i(47662);let r="sceneUboDeclaration",o=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},4560,27662,e=>{"use strict";var t=e.i(47662);let r="imageProcessingDeclaration",o=`#ifdef EXPOSURE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([],4560);let i="imageProcessingFunctions",a=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],27662)},82742,e=>{"use strict";var t=e.i(47662);let r="logDepthFragment",o=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([])},60334,83784,e=>{"use strict";var t=e.i(47662);let r="clipPlaneFragmentDeclaration",o=`#ifdef CLIPPLANE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([],60334);let i="clipPlaneFragment",a=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],83784)},53270,75587,e=>{"use strict";var t=e.i(47662);let r="fogFragmentDeclaration",o=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=o),e.s([],53270);let i="fogFragment",a=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],75587)},79799,e=>{"use strict";var t=e.i(47662);let r="reflectionFunction",o=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
