(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,82656,31116,e=>{"use strict";var t=e.i(47662);let o="lightFragmentDeclaration",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=r),e.s([],31116)},67654,e=>{"use strict";var t=e.i(47662);let o="shadowsFragmentFunctions",i=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},35716,e=>{"use strict";var t=e.i(47662);let o="reflectionFunction",i=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=r),e.s([],45107)},58492,e=>{"use strict";var t=e.i(47662);let o="decalFragmentDeclaration",i=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},79795,56015,e=>{"use strict";var t=e.i(47662);let o="depthPrePass",i=`#ifdef DEPTHPREPASS
