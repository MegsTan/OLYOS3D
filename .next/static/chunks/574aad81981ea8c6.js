(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,51894,13871,16507,70177,e=>{"use strict";var t=e.i(47662);let r="prePassDeclaration",a=`#ifdef PREPASS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],51894);let i="oitDeclaration",o=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=o),e.s([],13871);let f="depthPrePass",s=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[f]||(t.ShaderStore.IncludesShadersStoreWGSL[f]=s),e.s([],16507);let n="oitFragment",d=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=d),e.s([],70177)},20928,e=>{"use strict";var t=e.i(47662);let r="samplerFragmentDeclaration",a=`#ifdef _DEFINENAME_
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},4560,27662,e=>{"use strict";var t=e.i(47662);let r="imageProcessingDeclaration",a=`#ifdef EXPOSURE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],4560);let i="imageProcessingFunctions",o=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=o),e.s([],27662)},82742,e=>{"use strict";var t=e.i(47662);let r="logDepthFragment",a=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},60334,83784,e=>{"use strict";var t=e.i(47662);let r="clipPlaneFragmentDeclaration",a=`#ifdef CLIPPLANE
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],60334);let i="clipPlaneFragment",o=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=o),e.s([],83784)},53270,75587,e=>{"use strict";var t=e.i(47662);let r="fogFragmentDeclaration",a=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],53270);let i="fogFragment",o=`#ifdef FOG
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=o),e.s([],75587)},70619,e=>{"use strict";var t=e.i(47662);let r="lightUboDeclaration",a=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},70070,e=>{"use strict";var t=e.i(47662);let r="shadowsFragmentFunctions",a=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},97412,98135,e=>{"use strict";var t=e.i(47662);let r="ltcHelperFunctions",a=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],97412);let i="clusteredLightingFunctions",o=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=o),e.s([],98135)},79799,e=>{"use strict";var t=e.i(47662);let r="reflectionFunction",a=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},20385,e=>{"use strict";var t=e.i(47662);let r="lightFragment",a=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])},58420,51357,76632,e=>{"use strict";var t=e.i(47662);let r="bumpFragmentMainFunctions",a=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([],58420),e.i(20928);let i="bumpFragmentFunctions",o=`#if defined(BUMP)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=o),e.s([],51357);let f="bumpFragment",s=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[f]||(t.ShaderStore.IncludesShadersStoreWGSL[f]=s),e.s([],76632)},49637,e=>{"use strict";var t=e.i(47662);let r="decalFragment",a=`#ifdef DECAL
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=a),e.s([])}]);