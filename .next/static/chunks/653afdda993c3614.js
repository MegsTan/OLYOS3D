(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,12076,e=>{"use strict";var i=e.i(47662);e.i(84972),e.i(59791);let o="defaultUboDeclaration",r=`layout(std140,column_major) uniform;uniform Material
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.s([])},5622,e=>{"use strict";var i=e.i(47662);e.i(78153),e.i(95208);let o="lightsFragmentFunctions",r=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=r),e.i(12076),e.i(78144),e.i(45107),e.i(66058),e.i(87714),e.i(82656),e.i(31116),e.i(5622),e.i(67654),e.i(30550);let t="fresnelFunction",n=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.i(35716),e.i(57325),e.i(77772),e.i(37187),e.i(610),e.i(81239),e.i(45224),e.i(71154),e.i(79939),e.i(87126),e.i(75222),e.i(79795),e.i(60096),e.i(49426),e.i(72079),e.i(56015);let f="defaultPixelShader",l=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;i.ShaderStore.ShadersStore[f]||(i.ShaderStore.ShadersStore[f]=l),e.s(["defaultPixelShader",0,{name:f,shader:l}],4733)}]);