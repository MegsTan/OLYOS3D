(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,59791,e=>{"use strict";var t=e.i(47662);let o="meshUboDeclaration",i=`#ifdef WEBGL2
...
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},82656,31116,e=>{"use strict";var t=e.i(47662);let o="lightFragmentDeclaration",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([],82656);let a="lightUboDeclaration",r=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},67654,e=>{"use strict";var t=e.i(47662);let o="shadowsFragmentFunctions",i=`#ifdef SHADOWS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},35716,e=>{"use strict";var t=e.i(47662);let o="reflectionFunction",i=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},58492,e=>{"use strict";var t=e.i(47662);let o="decalFragmentDeclaration",i=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])},78144,45107,e=>{"use strict";var t=e.i(47662);let o="prePassDeclaration",i=`#ifdef PREPASS
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([],78144);let a="oitDeclaration",r=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=r),e.s([],45107)},79795,56015,e=>{"use strict";var t=e.i(47662);let o="depthPrePass",i=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([],79795);let a="oitFragment",r=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=r),e.s([],56015)},95208,60096,e=>{"use strict";var t=e.i(47662);let o="clusteredLightingFunctions",i=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([],95208);let a="lightFragment",r=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStore[a]||(t.ShaderStore.IncludesShadersStore[a]=r),e.s([],60096)},75222,e=>{"use strict";var t=e.i(47662);let o="decalFragment",i=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;t.ShaderStore.IncludesShadersStore[o]||(t.ShaderStore.IncludesShadersStore[o]=i),e.s([])}]);