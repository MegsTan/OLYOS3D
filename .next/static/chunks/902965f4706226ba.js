...
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([])},30514,e=>{"use strict";var i=e.i(47662);let t="harmonicsFunctions",n=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([])},24232,29344,41179,e=>{"use strict";var i=e.i(47662);let t="lightVxFragmentDeclaration",n=`#ifdef LIGHT{X}
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[r]||(i.ShaderStore.IncludesShadersStore[r]=f),e.s([],41179)},80801,26477,3590,39199,45898,84894,63990,e=>{"use strict";var i=e.i(47662);let t="decalVertexDeclaration",n=`#ifdef DECAL
...
#endif
`;i.ShaderStore.IncludesShadersStore[c]||(i.ShaderStore.IncludesShadersStore[c]=l),e.s([],39199);let d="prePassVertex",E=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[d]||(i.ShaderStore.IncludesShadersStore[d]=E),e.s([],45898);let s="uvVariableDeclaration",_=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;i.ShaderStore.IncludesShadersStore[s]||(i.ShaderStore.IncludesShadersStore[s]=_),e.s([],84894);let v="samplerVertexImplementation",N=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[v]||(i.ShaderStore.IncludesShadersStore[v]=N),e.s([],63990)},20554,e=>{"use strict";var i=e.i(47662);let t="bumpVertexDeclaration",n=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[t]||(i.ShaderStore.IncludesShadersStore[t]=n),e.s([])},91473,e=>{"use strict";var i=e.i(47662);e.i(80801);let t="pbrVertexDeclaration",n=`uniform mat4 view;uniform mat4 viewProjection;uniform vec4 vEyePosition;
#ifdef MULTIVIEW
