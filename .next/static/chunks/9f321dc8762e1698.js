...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=i),e.s([])},53707,88877,97280,66078,36226,32576,e=>{"use strict";var r=e.i(47662);let t="uvAttributeDeclaration",i=`#ifdef UV{X}
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[a]||(r.ShaderStore.IncludesShadersStoreWGSL[a]=o),e.s([],97280);let s="prePassVertex",d=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[s]||(r.ShaderStore.IncludesShadersStoreWGSL[s]=d),e.s([],66078);let c="uvVariableDeclaration",l=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[c]||(r.ShaderStore.IncludesShadersStoreWGSL[c]=l),e.s([],36226);let u="samplerVertexImplementation",v=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[u]||(r.ShaderStore.IncludesShadersStoreWGSL[u]=v),e.s([],32576)},64104,e=>{"use strict";var r=e.i(47662);let t="vertexColorMixing",i=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
