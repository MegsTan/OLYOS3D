...
h=sqrt(h);return vec2f(-b+h,-b-h);}`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=t),e.i(83784),e.i(20385),e.i(82742),e.i(75587);let o="backgroundPixelShader",f=`#include<backgroundUboDeclaration>
