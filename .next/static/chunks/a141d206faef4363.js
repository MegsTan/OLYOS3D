(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,56046,e=>{"use strict";var r=e.i(47662);e.i(51894),e.i(13871),e.i(60777),e.i(33781),e.i(70619),e.i(20928);let i="openpbrFragmentSamplersDeclaration",a=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[i]||(r.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.i(4560),e.i(60334),e.i(47193),e.i(53270),e.i(64500),e.i(90617),e.i(2241),e.i(11623),e.i(27662),e.i(70070),e.i(85633),e.i(21743),e.i(26857),e.i(45595),e.i(36730),e.i(40951),e.i(48424);let n="openpbrNormalMapFragmentMainFunctions",o=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[t]||(r.ShaderStore.IncludesShadersStoreWGSL[t]=f),e.i(79799);let s="openpbrDielectricReflectance",l=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[g]||(r.ShaderStore.IncludesShadersStoreWGSL[g]=v),e.i(83784),e.i(72596);let S="openpbrNormalMapFragment",I=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[M]||(r.ShaderStore.IncludesShadersStoreWGSL[M]=x),e.i(16507);let G="openpbrBackgroundTransmission",P=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;r.ShaderStore.IncludesShadersStoreWGSL[X]||(r.ShaderStore.IncludesShadersStoreWGSL[X]=B),e.i(82742),e.i(75587),e.i(88558),e.i(86826),e.i(70177),e.i(91032);let V="openpbrPixelShader",H=`#define OPENPBR_FRAGMENT_SHADER
...
`;r.ShaderStore.ShadersStoreWGSL[V]||(r.ShaderStore.ShadersStoreWGSL[V]=H),e.s(["openpbrPixelShaderWGSL",0,{name:V,shader:H}],56046)}]);