...
`;i.ShaderStore.IncludesShadersStore[n]||(i.ShaderStore.IncludesShadersStore[n]=a),e.i(12159),e.i(70562),e.i(82656),e.i(31116),e.i(30550);let r="samplerFragmentAlternateDeclaration",f=`#ifdef _DEFINENAME_
...
#endif
`;i.ShaderStore.IncludesShadersStore[o]||(i.ShaderStore.IncludesShadersStore[o]=t),e.i(57325),e.i(81239),e.i(45224),e.i(71154),e.i(87714),e.i(27068),e.i(28993),e.i(1010),e.i(77772),e.i(67654),e.i(30514),e.i(49579),e.i(95368),e.i(7199),e.i(33879),e.i(78167),e.i(99434),e.i(37187),e.i(610),e.i(35716),e.i(75222);let c="pbrBlockAlbedoOpacity",l=`struct albedoOpacityOutParams
...
return outParams;}
#endif
`;i.ShaderStore.IncludesShadersStore[_]||(i.ShaderStore.IncludesShadersStore[_]=M),e.i(95208);let h="pbrBlockReflectance0",D=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
...
return result;}
#endif
`;i.ShaderStore.IncludesShadersStore[F]||(i.ShaderStore.IncludesShadersStore[F]=g),e.i(79939),e.i(25472),e.i(87126);let P="pbrBlockNormalFinal",U=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;i.ShaderStore.IncludesShadersStore[P]||(i.ShaderStore.IncludesShadersStore[P]=U),e.i(79795);let b="pbrBlockLightmapInit",y=`#ifdef LIGHTMAP
...
#endif
`;i.ShaderStore.IncludesShadersStore[x]||(i.ShaderStore.IncludesShadersStore[x]=W),e.i(60096);let Y="pbrBlockFinalLitComponents",k=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
`;i.ShaderStore.IncludesShadersStore[K]||(i.ShaderStore.IncludesShadersStore[K]=z),e.i(49426),e.i(72079),e.i(86272),e.i(28767),e.i(56015),e.i(60382);let Z="pbrPixelShader",q=`#define PBR_FRAGMENT_SHADER
