...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([])},45595,e=>{"use strict";var t=e.i(47662);let r="pbrBRDFFunctions",f=`#define FRESNEL_MAXIMUM_ON_ROUGH 0.25
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([],2241);let i="hdrFilteringFunctions",a=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],36730)},72033,e=>{"use strict";var t=e.i(47662);let r="mainUVVaryingDeclaration",f=`#ifdef MAINUV{X}
varying vMainUV{X}: vec2f;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([])},47193,e=>{"use strict";var t=e.i(47662);let r="logDepthDeclaration",f=`#ifdef LOGARITHMICDEPTH
uniform logarithmicDepthConstant: f32;varying vFragmentDepth: f32;
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([])},60896,e=>{"use strict";var t=e.i(47662);let r="sceneUboDeclaration",f=`struct Scene {viewProjection : mat4x4<f32>,
#ifdef MULTIVIEW
...
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([])},80239,e=>{"use strict";var t=e.i(47662);let r="meshUboDeclaration",f=`struct Mesh {world : mat4x4<f32>,
visibility : f32,};var<uniform> mesh : Mesh;
#define WORLD_UBO
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([])},85633,e=>{"use strict";var t=e.i(47662);let r="harmonicsFunctions",f=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[r]||(t.ShaderStore.IncludesShadersStoreWGSL[r]=f),e.s([],33781);let i="subSurfaceScatteringFunctions",a=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;t.ShaderStore.IncludesShadersStoreWGSL[i]||(t.ShaderStore.IncludesShadersStoreWGSL[i]=a),e.s([],90617);let n="pbrHelperFunctions",o=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[n]||(t.ShaderStore.IncludesShadersStoreWGSL[n]=o),e.s([],11623),e.i(97412);let c="pbrDirectLightingSetupFunctions",l=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[c]||(t.ShaderStore.IncludesShadersStoreWGSL[c]=l),e.s([],21743);let s="pbrDirectLightingFalloffFunctions",d=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;t.ShaderStore.IncludesShadersStoreWGSL[s]||(t.ShaderStore.IncludesShadersStoreWGSL[s]=d),e.s([],26857),e.i(98135);let v="pbrBlockReflectance0",u=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[v]||(t.ShaderStore.IncludesShadersStoreWGSL[v]=u),e.s([],66364);let m="pbrDirectLightingFunctions",p=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
return result;}
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[m]||(t.ShaderStore.IncludesShadersStoreWGSL[m]=p),e.s([],40951);let h="pbrIBLFunctions",E=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[h]||(t.ShaderStore.IncludesShadersStoreWGSL[h]=E),e.s([],48424);let S="pbrBlockNormalGeometric",g=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[S]||(t.ShaderStore.IncludesShadersStoreWGSL[S]=g),e.s([],72596);let L="pbrBlockImageProcessing",R=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[L]||(t.ShaderStore.IncludesShadersStoreWGSL[L]=R),e.s([],88558);let N="pbrBlockPrePass",I=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[N]||(t.ShaderStore.IncludesShadersStoreWGSL[N]=I),e.s([],86826);let D="pbrDebug",A=`#if DEBUGMODE>0
...
#endif
`;t.ShaderStore.IncludesShadersStoreWGSL[D]||(t.ShaderStore.IncludesShadersStoreWGSL[D]=A),e.s([],91032)}]);